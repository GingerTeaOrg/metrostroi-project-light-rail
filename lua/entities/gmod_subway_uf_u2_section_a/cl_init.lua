...
ENT.ClientProps["headlights_on"] = {model = "models/lilly/uf/u2/headlights_on.mdl", pos = Vector(-0.35, 0, 0), ang = Angle(0, 0, 0), scale = 1}
ENT.ClientProps["IBISkey"] = {model = "models/lilly/uf/u2/cab/key.mdl", pos = Vector(00.3, 0, 0), ang = Angle(0, 0, 0), scale = 1}
ENT.ClientProps["cab"] = {model = "models/lilly/uf/u2/u2-cabfront.mdl", pos = Vector(0, 0, 0), ang = Angle(0, 0, 0), scale = 1, nohide = true}

ENT.ClientProps["cab_decal"] = {model = "models/lilly/uf/u2/u2-cabfront-decal-1968.mdl", pos = ENT.DecalPos, ang = Angle(0, 0, 0), scale = 1, nohide = true}
ENT.ClientProps["carnumber1"] = {model = "models/lilly/uf/u2/carnumber_front_1.mdl", pos = ENT.CarNumPos, ang = Angle(0, 0, 0), scale = 1, nohide = true}
ENT.ClientProps["carnumber2"] = {model = "models/lilly/uf/u2/carnumber_front_2.mdl", pos = ENT.CarNumPos, ang = Angle(0, 0, 0), scale = 1, nohide = true}
ENT.ClientProps["carnumber3"] = {model = "models/lilly/uf/u2/carnumber_front_3.mdl", pos = ENT.CarNumPos, ang = Angle(0, 0, 0), scale = 1, nohide = true}

ENT.ClientProps["carnumber1int"] = {model = "models/lilly/uf/u2/intnum1.mdl", pos = Vector(0, 0, 0), ang = Angle(0, 0, 0), scale = 1, nohide = true}
ENT.ClientProps["carnumber2int"] = {model = "models/lilly/uf/u2/intnum2.mdl", pos = Vector(0, 0, 0), ang = Angle(0, 0, 0), scale = 1, nohide = true}
ENT.ClientProps["carnumber3int"] = {model = "models/lilly/uf/u2/intnum3.mdl", pos = Vector(0, 0, 0), ang = Angle(0, 0, 0), scale = 1, nohide = true}
ENT.ClientProps["switching_iron"] = {model = "models/lilly/uf/u2/switching_iron.mdl", pos = Vector(0, 0, 0), ang = Angle(0, 0, 0), scale = 1, nohide = true}

ENT.ClientProps["RetroEquipment"] = {model = "models/lilly/uf/u2/retroprop.mdl", pos = Vector(0, 0, 0), ang = Angle(0, 0, 0), scale = 1, nohide = true}

ENT.ClientProps["Door_fr1"] = {model = "models/lilly/uf/u2/door_h_fr1.mdl", pos = Vector(0, 0, 0), ang = Angle(0, 0, 0), scale = 1, nohide = true}

ENT.ClientProps["Door_fr2"] = {model = "models/lilly/uf/u2/door_h_fr2.mdl", pos = Vector(0, 0, 0), ang = Angle(0, 0, 0), scale = 1, nohide = true}

ENT.ClientProps["Door_fl1"] = {model = "models/lilly/uf/u2/door_h_fr1.mdl", pos = Vector(721.5, 0, 0), ang = Angle(0, 180, 0), scale = 1, nohide = true}

ENT.ClientProps["Door_fl2"] = {model = "models/lilly/uf/u2/door_h_fr2.mdl", pos = Vector(721.5, 0, 0), ang = Angle(0, 180, 0), scale = 1, nohide = true}

ENT.ClientProps["Door_rr1"] = {model = "models/lilly/uf/u2/door_h_fr1.mdl", pos = Vector(-242, 0, 0), ang = Angle(0, 0, 0), scale = 1, nohide = true}

ENT.ClientProps["Door_rr2"] = {model = "models/lilly/uf/u2/door_h_fr2.mdl", pos = Vector(-242, 0, 0), ang = Angle(0, 0, 0), scale = 1, nohide = true}

ENT.ClientProps["Door_rl1"] = {model = "models/lilly/uf/u2/door_h_fr1.mdl", pos = Vector(479, 0, 0), ang = Angle(0, 180, 0), scale = 1, nohide = true}

ENT.ClientProps["Door_rl2"] = {model = "models/lilly/uf/u2/door_h_fr2.mdl", pos = Vector(479, 0, 0), ang = Angle(0, 180, 0), scale = 1, nohide = true}

ENT.ClientProps["IBIS"] = {model = "models/lilly/uf/u2/IBIS.mdl", pos = Vector(0.1, 0, 0), ang = Angle(0, 0, 0), scale = 1, nohide = true}

ENT.ClientProps["duewag_decal"] = {model = "models/lilly/uf/u2/duewag_decal.mdl", pos = Vector(0.1, 0, 0), ang = Angle(0, 0, 0), scale = 1}

ENT.ClientProps["window_cab_l"] = {model = "models/lilly/uf/u2/window_cab_l.mdl", pos = Vector(0, 0, 0), ang = Angle(0, 0, 0), scale = 1}

ENT.ClientProps["window_cab_r"] = {model = "models/lilly/uf/u2/window_cab_r.mdl", pos = Vector(0, 0, 0), ang = Angle(0, 0, 0), scale = 1}

ENT.ClientProps["Throttle"] = {model = "models/lilly/uf/common/cab/throttle.mdl", pos = Vector(0, 0, 0), ang = Angle(0, 0, 0), nohide = true}

ENT.ClientProps["drivers_door"] = {model = "models/lilly/uf/u2/drivers_door.mdl", pos = Vector(0, 0, 0), ang = Angle(0, 0, 0), nohide = true}

ENT.ClientProps["Mirror"] = {model = "models/lilly/uf/u2/mirror.mdl", pos = Vector(0, 0, 0), ang = Angle(0, 0, 0), nohide = true}

ENT.ClientProps["Mirror_vintage"] = {model = "models/lilly/uf/u2/mirror_vintage.mdl", pos = Vector(0, 0, 0), ang = Angle(0, 0, 0), nohide = true}

ENT.ClientProps["Speedo"] = {model = "models/lilly/uf/u2/cab/speedo.mdl", pos = Vector(418.192, 10, 54.66), ang = Angle(-8.7, 0, 0), nohide = true}
...
ENT.ClientProps["DriverLightSwitch"] = {model = "models/lilly/uf/u2/cab/battery_switch.mdl", pos = Vector(415.7, -7, 54.5), ang = Angle(-8.5, 0, 0), hideseat = 0.2}

ENT.ClientProps["Voltage"] = {model = "models/lilly/uf/u2/cab/gauge.mdl", pos = Vector(418, 18.7, 54.8), ang = Angle(-12, 0, 0), hideseat = 0.2}

ENT.ClientProps["Amps"] = {model = "models/lilly/uf/u2/cab/gauge.mdl", pos = Vector(418, 1.5, 54.8), ang = Angle(-12, 0, 0), hideseat = 0.2}

ENT.ClientProps["reverser"] = {model = "models/lilly/uf/u2/cab/reverser_lever.mdl", pos = Vector(-0.1, -0.25, 0), ang = Angle(0, 0, 0), hideseat = 0.2}

ENT.ClientProps["blinds_l"] = {model = "models/lilly/uf/u2/cab/blinds.mdl", pos = Vector(-0.6, 0, 0), ang = Angle(0, 0, 0), hideseat = 8}
...
ENT.ButtonMap["Cab"] = {
	...
	buttons = {
		...
		},
		{
			...
			model = {model = "models/lilly/uf/u2/cab/button_bulge_blue.mdl", z = 0, ang = 45, anim = false, var = "HighbeamLamp"}
		},
		{
			ID = "AutomatOnSet",
			x = 118.5,
	...
	buttons = {
		{
			...
			model = {var = "OpenBOStrab", sndvol = 1, snd = function(val) return val and "door_cab_open" or "door_cab_close" end, sndmin = 90, sndmax = 1e3, sndang = Angle(-90, 0, 0)}
		}
	}
}
	...
	buttons = {
		{
			...
			model = {var = "TurnIBISKey", sndvol = 1, snd = function(val) return val and "door_cab_open" or "door_cab_close" end, sndmin = 90, sndmax = 1e3, sndang = Angle(-90, 0, 0)}
		}
	}
}
...
ENT.ButtonMap["Microphone"] = {
	...
	height = 50,
	scale = 0.0625,
	buttons = {{ID = "ComplaintSet", x = 10, y = 10, z = 0, w = 5, h = 5, radius = 90, tooltip = "Activate Driver's Rage"}}
}
	...
	buttons = {
		...
		},
		{
			...
			model = {
				...
				var = "WarnBlink",
				sndvol = 1,
				snd = function(val, val2) return val and "switch_panel_up" or "switch_panel_down" end,
				sndmin = 80,
				sndmax = 1e3 / 3,
				sndang = Angle(-90, 0, 0)
			}
...
function ENT:Think()
	...
	elseif self:GetNW2String("Texture", "") == "OrEbSW" or self:GetNW2String("Texture", "") == "OrEbSW_2" then
		...
		if IsValid(self.u2sectionb) and IsValid(leftNum1) and IsValid(middleNum2) and IsValid(rightNum3) then
		...
		if IsValid(self.u2sectionb) and IsValid(self.u2sectionb.ClientEnts["cab_decal"]) and IsValid(self.u2sectionb.ClientEnts["duewag_decal"]) then
	...
	elseif self:GetNW2Bool("RetroMode", false) == true and self:GetNW2Bool("OldMirror", false) == false or self:GetNW2Bool("OldMirror", false) == true
	...
	self:Animate("Speedo", self.SpeedoAnim, 0, 100, 32, false, 0)
	...
	if self:GetNW2Bool("BatteryOn", false) == true then
		...
		elseif self:GetNW2Bool("Fans", false) == false and self:GetNW2Bool("BatteryOn", false) == false or self:GetNW2Bool("Fans", false) == true and self:GetNW2Bool("BatteryOn", false)
					== false then
		...
		if self:GetPackedBool("WarningAnnouncement") == true then self:PlayOnce("Keep Clear", Vector(350, -30, 113), 1, 1) end
