	...
	buttons = {
		...
		},
		{
			...
			model = {
				...
				vmax = 1,
				sndvol = 1,
				snd = function( val ) return val and "button_toggle_on" or "button_toggle_off" end,
				sndmin = 80,
				sndmax = 1e3 / 3,
				sndang = Angle( -90, 0, 0 )
			}
...
function ENT:DrawPost()
	...
	self:DrawOnPanel( "LineRollsignR", function( ... )
		surface.SetDrawColor( color_white )
		surface.SetMaterial( mat2 )
		surface.DrawTexturedRectUV( 1, 0, 26.5, 7.6, 1.001, self.ScrollModifier3 - 1.45, -0.037, self.ScrollModifier3 - 1.5 )
	end )
