...
function ENT:Initialize()
	...
	self.MiddleBogey1 = self:CreateBogeyMPLR( Vector( 140, 0, 5 ), Angle( 0, 0, 0 ), true, "pt", "c" ) --pos, ang, forward, typ, a_b
	self.MiddleBogey2 = self:CreateBogeyMPLR( Vector( -140, 0, 5 ), Angle( 0, 0, 0 ), true, "pt", "c" )
	...
	self.SectionA.SectionC = self
	self.FrontBogey = self:CreateBogeyMPLR( Vector( 260, 0, 0 ), Angle( 0, 0, 0 ), true, "pt", "a" ) --pos, ang, forward, typ, a_b
	self.SectionB = self:CreateSection( Vector( -145, 0, 2.8 ), Angle( 0, 180, 0 ), "gmod_subway_uf_pt_section_ab", self, self, self.SectionA )
	self.SectionB.SectionC = self
	self.RearBogey = self:CreateBogeyMPLR( Vector( 260, 0, 0 ), Angle( 0, 5, 0 ), false, "pt", "b" )
	self.FrontCouple = self.SectionA:CreateCustomCoupler( Vector( 390, 0, 10 ), Angle( 0, 0, 0 ), true, "pt", "a" ) --pos, ang, forward, typ, a_b
	--timer.Simple( 5, function() self.RearCouple = self.SectionB:CreateCustomCoupler( Vector( 390, 0, 10 ), Angle( 0, 0, 0 ), false, "pt", "b" ) end )
