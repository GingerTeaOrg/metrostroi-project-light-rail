...
function ENT:Think( dT )
	...
	self:SetNW2Float( "BatteryVoltage", 20 )
...
function ENT:Traction()
	...
	self.FrontBogey.MotorForce = traction > 0 and 50688.07175 or -78363.606
...
function ENT:OnButtonPress( button, ply )
	...
	if button == "PantographRaiseSet" and self.CoreSys.BatteryOn then self.PantoUp = true end
	if button == "PantographLowerSet" then if self.CoreSys.BatteryOn then self.PantoUp = false end end
	...
	if button == "BatteryOnSet" and self.BatteryOn == false and self.CoreSys.ReverserLeverStateA == 1 then self.BatteryOn = true end
	if button == "BatteryDisableSet" and self.BatteryOn == true and self.CoreSys.ReverserLeverStateA == 1 then self.BatteryOn = false end
