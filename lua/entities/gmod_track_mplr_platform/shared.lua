...
hook.Add( "CanProperty", "Trolleybus_System_Stops", function( ply, property, ent ) if ent:GetClass() == "gmod_track_mplr_platform" then return false end end )
hook.Add( "CanTool", "Trolleybus_System_Stops", function( ply, tr, toolname, tool, button ) if IsValid( tr.Entity ) and tr.Entity:GetClass() == "gmod_track_mplr_platform" then return false end end )