...
function ENT:InitializeSounds() self.BaseClass.InitializeSounds(self) end
...
function ENT:ScrollDestinations(offset) end

ENT.SubwayTrain = {Type = "P8", Name = "Pt", WagType = 0, Manufacturer = "Duewag"}
