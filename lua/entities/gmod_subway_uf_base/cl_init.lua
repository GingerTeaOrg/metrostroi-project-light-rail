...
hook.Add("HUDShouldDraw","MPLRHUDHider",function(name)
...
hook.Add("PlayerButtonDown", "mplr-cabin-buttons", function(ply,key) handleKeyEvent(ply, key,true) handleCam(ply,key) end)
...
if game.SinglePlayer() then
    ...
    net.Receive("PlayerButtonUp_mplr",function()
