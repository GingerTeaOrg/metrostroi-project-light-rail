...
function TRAIN_SYSTEM:Initialize()
	self.Train:LoadSystem( "Shedrun", "Relay", "Switch", {
		bass = true
	} )

	self.Train:LoadSystem( "AutomatOn", "Relay", "Switch", {
		bass = true
	} )

	self.Train:LoadSystem( "AutomatOff", "Relay", "Switch", {
		bass = true
	} )
	...
	self.Train:LoadSystem( "SPADReset", "Relay", "Switch", {
		bass = true
	} )
	...
	self.Train:LoadSystem( "ServiceAnnouncement", "Relay", "Switch", {
		bass = true
	} )
...
function TRAIN_SYSTEM:Outputs()
	return { "Shedrun", "AutomatOn", "AutomatOff", "DoorsLock", "DoorsSelectRight", "DoorsSelectLeft", "DeadmanPedal", "Wiper", "BlinkerRight", "BlinkerLeft", "WarnBlink", "Microphone", "BellEngage", "Horn", "WarningAnnouncement", "PantographRaise", "PantographLower", "DoorsCloseConfirm", "PassengerLightsOn", "PassengerLightsOff", "SetHoldingBrake", "ReleaseHoldingBrake", "DoorsCloseConfirm", "SetPointRight", "SetPointLeft", "ThrowCoupler", "Door1", "UnlockDoors", "DoorCloseSignal", "Number1", "Number2", "Number3", "Number4", "Number6", "Number7", "Number8", "Number9", "Number0", "Destination", "Delete", "Route", "DateAndTime", "ServiceAnnouncement", "Headlights", "SPADReset" }
end