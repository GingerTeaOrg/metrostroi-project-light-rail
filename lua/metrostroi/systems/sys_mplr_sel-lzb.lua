...
function TRAIN_SYSTEM:Initialize()
	local t = self.Train
	if not t.LZBTab then return end
	local tab = t.LZBTab
	...
	self.StepControl = t.SubwayTrain.StepsMedium or t.SubwayTrain.StepsLow and true or false
end
...
function TRAIN_SYSTEM:UpdatePosition()
	self.Pos = MPLR.GetPositionOnTrack( self.Train:GetPos(), self.Train:GetAngles() )
end
...
function TRAIN_SYSTEM:DoorControl()
end