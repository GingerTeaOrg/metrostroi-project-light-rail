...
language.Add( "tool.mplr_trafficeditor.name", L"tool.trolleytrafficeditor.name" )
language.Add( "tool.mplr_trafficeditor.desc", L"tool.trolleytrafficeditor.desc" )
language.Add( "tool.mplr_trafficeditor.left", L"tool.trolleytrafficeditor.left" )
language.Add( "tool.mplr_trafficeditor.right", L"tool.trolleytrafficeditor.right" )
language.Add( "tool.mplr_trafficeditor.right_use", L"tool.trolleytrafficeditor.right_use" )
language.Add( "tool.mplr_trafficeditor.reload", L"tool.trolleytrafficeditor.reload" )
language.Add( "tool.mplr_trafficeditor.left1", L"tool.trolleytrafficeditor.left1" )
language.Add( "tool.mplr_trafficeditor.right1", L"tool.trolleytrafficeditor.right1" )
language.Add( "tool.mplr_trafficeditor.left2", L"tool.trolleytrafficeditor.left2" )
language.Add( "tool.mplr_trafficeditor.left3", L"tool.trolleytrafficeditor.left3" )
language.Add( "tool.mplr_trafficeditor.left4", L"tool.trolleytrafficeditor.left4" )
language.Add( "tool.mplr_trafficeditor.reload1", L"tool.trolleytrafficeditor.reload1" )
language.Add( "tool.mplr_trafficeditor.reload2", L"tool.trolleytrafficeditor.reload2" )
language.Add( "tool.mplr_trafficeditor.left5", L"tool.trolleytrafficeditor.left5" )
language.Add( "tool.mplr_trafficeditor.left_use", L"tool.trolleytrafficeditor.left_use" )
language.Add( "tool.mplr_trafficeditor.right_use2", L"tool.trolleytrafficeditor.right_use2" )
...
function TOOL:LeftClick( trace )
	--if not Trolleybus_System.RunEvent( "HasAccessToTool", self:GetOwner(), "trolleytrafficeditor" ) then return false end
	if Trolleybus_System.ToolsDisallowed( self:GetOwner() ) then return false end
	local op = self:GetOperation()
	if op == 3 and ( not IsValid( trace.Entity ) or trace.Entity:GetClass() ~= "trolleybus_trafficlight" ) then return false end
	return true
end
...
function TOOL:Reload()
	...
	if op == 0 then
		...
		if not Trolleybus_System.GetTrafficTracks()[ id ] then return false end
	end
	return true
end
...
function TOOL:DrawHUD()
	...
	for k, v in pairs( Trolleybus_System.GetTrafficTracks() ) do
		...
		local color = track and ( track == v and Color( 255, 255, 0 ) or track.LookBase == k and table.HasValue( track.Next, k ) and Color( 0, 255, 255 ) or table.HasValue( track.Next, k ) and Color( 0, 255, 0 ) or track.LookBase == k and table.HasValue( track.Prev, k ) and Color( 255, 0, 255 ) or table.HasValue( track.Prev, k ) and Color( 255, 0, 0 ) or track.Look and table.HasValue( track.Look, k ) and Color( 255, 150, 0 ) or track.LookBase == k and Color( 0, 150, 255 ) ) or color_white
...
function TOOL.BuildCPanel( panel )
	...
	pnl.TrackIDTextEntry.AllowInput = function( s, c ) return not c:find( "%d" ) end
	...
	pnl.NextTracksTextEntry.AllowInput = function( s, c ) return not c:find( "[%d,]" ) end
	...
	pnl.PrevTracksTextEntry.AllowInput = function( s, c ) return not c:find( "[%d,]" ) end
	...
	pnl.TurnSignalLeft.OnChange = function( s, val ) if val and pnl.TurnSignalRight:GetChecked() then pnl.TurnSignalRight:SetChecked( false ) end end
	...
	pnl.TurnSignalRight.OnChange = function( s, val ) if val and pnl.TurnSignalLeft:GetChecked() then pnl.TurnSignalLeft:SetChecked( false ) end end
	...
	pnl.LookAroundTracks.AllowInput = function( s, c ) return not c:find( "[%d,]" ) end
	pnl.LookAroundTracks.Think = function( s ) s:SetEnabled( pnl.LookAroundBase:GetText() == "" ) end
	...
	pnl.LookAroundBase.AllowInput = function( s, c ) return not c:find( "%d" ) end
	pnl.LookAroundBase.Think = function( s ) s:SetEnabled( pnl.LookAroundTracks:GetText() == "" ) end
...
net.Receive( "TrolleybusTrafficTrackEditor", function( len )
	...
	elseif cmd == 4 then
		local isend = net.ReadBool()
		local pos = net.ReadVector()
		if IsValid( pnl ) then pnl.RotationData[ isend and 2 or 1 ] = pos end
	elseif cmd == 5 then
