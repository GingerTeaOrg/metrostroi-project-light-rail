...
CreateConVar( "mplr_rerail_debug", 0, { FCVAR_ARCHIVE }, "Enable or disable rerailer debug", 0, 1 )
cvars.AddChangeCallback( "mplr_voltage", function() UV.VoltageChanged() end )
